...
ESP32 dashboard builds are the full-featured path. They use pinned ESP-IDF v6.0.1 through PlatformIO and include the web UI, WiFi, OTA, and persistent runtime settings.
